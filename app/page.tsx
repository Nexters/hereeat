...
function getBgClass(colorVar: string): string {
  const bgClassMap: Record<string, string> = {
    'common-black': 'ygi:bg-palette-common-black',
    'common-white': 'ygi:bg-palette-common-white',
    'gray-50': 'ygi:bg-palette-gray-50',
    'gray-100': 'ygi:bg-palette-gray-100',
    'gray-200': 'ygi:bg-palette-gray-200',
    'gray-300': 'ygi:bg-palette-gray-300',
    'gray-400': 'ygi:bg-palette-gray-400',
    'gray-500': 'ygi:bg-palette-gray-500',
    'gray-600': 'ygi:bg-palette-gray-600',
    'gray-700': 'ygi:bg-palette-gray-700',
    'gray-800': 'ygi:bg-palette-gray-800',
    'gray-900': 'ygi:bg-palette-gray-900',
    'primary-50': 'ygi:bg-palette-primary-50',
    'primary-100': 'ygi:bg-palette-primary-100',
    'primary-200': 'ygi:bg-palette-primary-200',
    'primary-300': 'ygi:bg-palette-primary-300',
    'primary-400': 'ygi:bg-palette-primary-400',
    'primary-500': 'ygi:bg-palette-primary-500',
    'primary-600': 'ygi:bg-palette-primary-600',
    'primary-700': 'ygi:bg-palette-primary-700',
    'primary-800': 'ygi:bg-palette-primary-800',
    'primary-900': 'ygi:bg-palette-primary-900',
    'secondary-50': 'ygi:bg-palette-secondary-50',
    'secondary-100': 'ygi:bg-palette-secondary-100',
    'secondary-200': 'ygi:bg-palette-secondary-200',
    'secondary-300': 'ygi:bg-palette-secondary-300',
    'secondary-400': 'ygi:bg-palette-secondary-400',
    'secondary-500': 'ygi:bg-palette-secondary-500',
    'secondary-600': 'ygi:bg-palette-secondary-600',
    'secondary-700': 'ygi:bg-palette-secondary-700',
    'secondary-800': 'ygi:bg-palette-secondary-800',
    'secondary-900': 'ygi:bg-palette-secondary-900',
    'green-100': 'ygi:bg-palette-green-100',
    'green-300': 'ygi:bg-palette-green-300',
    'green-500': 'ygi:bg-palette-green-500',
    'green-700': 'ygi:bg-palette-green-700',
    'green-900': 'ygi:bg-palette-green-900',
    'yellow-100': 'ygi:bg-palette-yellow-100',
    'yellow-300': 'ygi:bg-palette-yellow-300',
    'yellow-500': 'ygi:bg-palette-yellow-500',
    'yellow-700': 'ygi:bg-palette-yellow-700',
    'yellow-900': 'ygi:bg-palette-yellow-900',
    'opacity-gray-2': 'ygi:bg-palette-opacity-gray-2',
    'opacity-gray-4': 'ygi:bg-palette-opacity-gray-4',
    'opacity-gray-8': 'ygi:bg-palette-opacity-gray-8',
    'opacity-gray-16': 'ygi:bg-palette-opacity-gray-16',
    'opacity-gray-50': 'ygi:bg-palette-opacity-gray-50',
    'opacity-gray-80': 'ygi:bg-palette-opacity-gray-80',
  };
